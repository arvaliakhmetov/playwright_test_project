...
function open_instruction(){
    var os = get_os();
    if ("Windows" === os)
        open_url('http://cpdn.cryptopro.ru/default.asp?url=content/cades/plugin-installation-windows.html');
    if ("UNIX" === os)
        open_url('http://cpdn.cryptopro.ru/default.asp?url=content/cades/plugin-installation-unix.html');
    if ("MacOS" === os)
        open_url('http://cpdn.cryptopro.ru/default.asp?url=content/cades/plugin-installation-macos.html');
}
function open_forum(){
